...
MONGO_DB = getenv("MONGO_DB", "mongodb+srv://damealorica:AtfnHOxzIGpFS9pk@saverbot.znrlqwc.mongodb.net/?retryWrites=true&w=majority&appName=SaverBot")
LOG_GROUP = getenv("LOG_GROUP", "-1002727221517")
CHANNEL_ID = int(getenv("CHANNEL_ID", "-1002600575573"))
